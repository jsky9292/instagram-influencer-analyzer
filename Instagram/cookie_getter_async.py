...
async def get_instagram_cookies_async(username, password, save_path="ig_cookies.json"):
    """비동기 Instagram 쿠키 생성기"""
    async with async_playwright() as p:
        ...
        try:
            ...
            # 쿠키 동의 버튼이 있으면 클릭
            try:
                await page.click("button:has-text('Allow essential and optional cookies')", timeout=2000)
            except:
                pass
